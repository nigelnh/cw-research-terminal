...
class ResearchContextEnvelope(BaseModel):
    ...
    watchedSymbols: Optional[List[str]] = Field(default_factory=list, description="Watched symbols list")
    watchlist: Optional[List[str]] = Field(default_factory=list, description="Watched symbols list")
    activeHistoryRange: Optional[str] = None
    realtimeStatus: Optional[str] = None
    dataMode: Optional[str] = None
    marketSession: Optional[str] = None
    marketSessionActive: Optional[bool] = None
