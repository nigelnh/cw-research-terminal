...
class MarketState:
        ...
        with self._lock:
            ...
            for s in symbols:
                ...
                if sym in self._quotes:
                    rows.append(self._quotes[sym].to_wire_snapshot_row())
            return rows
    ...
    def apply_trade_event(self, raw_event: Dict[str, Any]) -> Tuple[CanonicalQuote, Dict[str, Any]]:
        ...
        match_price = raw_event.get("Close") or raw_event.get("MatchPrice") or raw_event.get("Price")
        ref_price = raw_event.get("ReferencePrice") or raw_event.get("RefPrice")
        ceil_price = raw_event.get("CeilingPrice")
        floor_price = raw_event.get("FloorPrice")
        open_price = raw_event.get("Open") or raw_event.get("OpenPrice")
        high_price = raw_event.get("High") or raw_event.get("HighPrice")
        low_price = raw_event.get("Low") or raw_event.get("LowPrice")
        avg_price = raw_event.get("AveragePrice")

        change = raw_event.get("change")
        change_pct = raw_event.get("ChangePercent") or raw_event.get("ChangeRate")
        tot_vol = raw_event.get("TotalMatchVolume") or raw_event.get("TotalVolume") or raw_event.get("Volume")
        traded_qty = raw_event.get("MatchVolume") or raw_event.get("TradedVolume")
        tot_val = raw_event.get("TotalMatchValue") or raw_event.get("TotalValue")
    ...
    def apply_bidask_event(self, raw_event: Dict[str, Any]) -> Tuple[CanonicalQuote, Dict[str, Any]]:
        ...
        # Depth 1
        b1_prc = raw_event.get("Best1Bid") or raw_event.get("BidPrice1") or raw_event.get("Bid1")
        b1_vol = raw_event.get("Best1BidVolume") or raw_event.get("BidVol1") or raw_event.get("Bid1Vol")
        a1_prc = raw_event.get("Best1Ask") or raw_event.get("AskPrice1") or raw_event.get("Ask1")
        a1_vol = raw_event.get("Best1AskVolume") or raw_event.get("AskVol1") or raw_event.get("Ask1Vol")

        # Depth 2
        b2_prc = raw_event.get("Best2Bid") or raw_event.get("BidPrice2")
        b2_vol = raw_event.get("Best2BidVolume") or raw_event.get("BidVol2")
        a2_prc = raw_event.get("Best2Ask") or raw_event.get("AskPrice2")
        a2_vol = raw_event.get("Best2AskVolume") or raw_event.get("AskVol2")

        # Depth 3
        b3_prc = raw_event.get("Best3Bid") or raw_event.get("BidPrice3")
        b3_vol = raw_event.get("Best3BidVolume") or raw_event.get("BidVol3")
        a3_prc = raw_event.get("Best3Ask") or raw_event.get("AskPrice3")
        a3_vol = raw_event.get("Best3AskVolume") or raw_event.get("AskVol3")
