...
function watchlistWith(symbol: string, underlyingSymbol: string) {
  return {
    ...
    name: "wl",
    items: [
      { symbol, instrumentType: "CW" as const, underlyingSymbol, addedAt: 0 },
    ],
    createdAt: 0,
    updatedAt: 0,
    version: 3,
...
describe("Dashboard contract metadata comes from the canonical registry, not the watchlist item", () => {
  beforeEach(() => {
    ...
    s.setItem("cw:watchlist:full-columns", "true");
  });
      ...
      seedInstrumentSpecs([
        {
          ...
          lastTradingDate: "2027-02-15",
          dataQuality: "COMPLETE",
          metadataVerification: "VERIFIED_CURRENT",
        },
      ]),
    ]);
